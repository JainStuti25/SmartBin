...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cameraView = (CameraView) textViewResult.findViewById();
        imageViewResult = (ImageView) textViewResult.findViewById();
        textViewResult = (TextView) textViewResult.findViewById();
